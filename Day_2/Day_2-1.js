...
function checkCode(min, max, param, code) {  //Takes input[i] and counts number of param letter in code and validates it
    ...
    if (count >= min && count <= max) { //This takes total number from for loop and checks it against validation params
        codeCount = codeCount + 1
        console.log("Valid! " + count + " " + codeCount + " " + min + " " + max)
    } else { 
        console.log("Invalid " + count + " " + codeCount + " " + min + " " + max)
    }
